...
UE5.3.2 기반으로 Smart Object, ABP, Motion Matching 등 Unreal 기능을 통한 개발을 진행하고 있습니다.
...
CommonUI를 통한 위젯 작업을 진행합니다. 추후 Dedicated Server을 위해 ProjectKR와 레이어를 나누었습니다.

ProjectKREditor 에디터 레이어
Editor 기반 기능들을 제작합니다.
